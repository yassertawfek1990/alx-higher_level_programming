...
class TestMaxInteger(unittest.TestCase):
    ...
    def t_ins_and_floats(self):
        """Unittes"""
        self.assertEqual(
            max_integer(
                [10, 99.8, -100, -0.1, 1000, 9999, -100000, 9998.9]), 9999)

    def t_its_and_floats_large(self):
        """Unitte"""
        self.assertEqual(
            max_integer(
    ...
    def t_mied_list(self):
        """Unitt"""
        with self.assertRaises(TypeError):
            max_integer([[], [2], [4], [2, 9], 99, "foo"])

    def t_mied_list_int_str(self):
        """Unitt"""
        with self.assertRaises(TypeError):
            max_integer([99, "foo"])
